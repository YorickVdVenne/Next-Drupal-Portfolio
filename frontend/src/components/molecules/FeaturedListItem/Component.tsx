...
export default function FeaturedListItem(
  ...
  return (
    <li className={clsx(gridStyles.grid, styles.featuredItem)}>
      <div
        className={clsx(styles.projectContent, {
          [styles.contentLeft]: textAlign === TextAlign.left,
        })}
      >
        <p className={styles.projectOverline}>
          {t("featuredProjects.overlineText")}
        </p>
        ...
        <ul
          className={clsx(styles.projectTech, {
        ...
        >
          {item.technologies.map((tech, key) => (
            <li
              key={key}
              className={clsx(styles.techItem, {
        ...
        <div
          className={clsx(styles.itemActions, {
            [styles.itemActionsLeft]: textAlign === TextAlign.left,
          })}
        >
          <div
            className={clsx(styles.projectLinks, {
          ...
          <div
            className={clsx(styles.buttonWrapper, {
              [styles.buttonWrapperLeft]: textAlign === TextAlign.left,
            })}
          >
            <Link href={`/projects/${item.id}`}>
              <Button className={styles.readMoreButton} as="button">
                {t("button.readMore", { ns: "common" })}
              </Button>
            </Link>
          </div>
        </div>
      ...
      <div
        className={clsx(styles.projectImage, {
