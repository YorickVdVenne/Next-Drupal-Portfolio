...
namespace Drupal\graphql_content\Plugin\GraphQL\DataProducer;
 ...
 * @DataProducer(
 *   id = "query_projects",
 *   name = @Translation("Load projects"),
...
class QueryProjects extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @return \Drupal\graphql_content\Wrappers\QueryConnection
  ...
  public function resolve($offset, $limit, RefinableCacheableDependencyInterface $metadata) {
    ...
    $query->condition($entityType->getKey('bundle'), 'project');
