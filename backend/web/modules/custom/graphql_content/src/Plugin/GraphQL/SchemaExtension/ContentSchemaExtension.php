...
namespace Drupal\graphql_content\Plugin\GraphQL\SchemaExtension;
...
/**
 * @SchemaExtension(
 *   id = "graphql_content_extension",
 *   name = "Graphql content extension",
 *   description = "A simple extension that adds node related fields.",
 *   schema = "graphql_content"
 * )
 */
class ContentSchemaExtension extends SdlSchemaExtensionPluginBase {
